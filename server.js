...
// Ganti baris app.use(cors()); dengan blok kode di bawah ini

// 1. Definisikan URL frontend Vercel Anda
const vercelAppUrl = 'https://URL-FRONTEND-VERCEL-ANDA.vercel.app'; // <-- Ganti dengan URL Vercel Anda

// 2. Buat opsi untuk CORS
const corsOptions = {
  origin: vercelAppUrl,
